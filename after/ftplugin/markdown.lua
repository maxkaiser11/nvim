...
-- ---------------------------------------------------------------------------
-- Smart list toggle (cycles bullets -> checkboxes -> numbers -> none)
-- ---------------------------------------------------------------------------
...
-- visual mode (use commands to preserve selection)
vim.keymap.set("v", "tn", ":<C-u>ToggleNumberVisual<CR>", { desc = "Toggle numbers on selection", buffer = true })
vim.keymap.set("v", "tb", ":<C-u>ToggleBulletVisual<CR>", { desc = "Toggle bullets on selection", buffer = true })
vim.keymap.set("v", "tc", ":<C-u>ToggleCheckboxVisual<CR>", { desc = "Toggle checkboxes on selection", buffer = true })
vim.keymap.set("v", "tt", ":<C-u>ToggleTaskStateVisual<CR>", { desc = "Toggle task state on selection", buffer = true })
vim.keymap.set("v", "tl", ":<C-u>SmartListToggleVisual<CR>", { desc = "Smart list toggle on selection", buffer = true })
...
-- ---------------------------------------------------------------------------
local cmd_opts = { buffer = 0, silent = true }
...
vim.keymap.set(
  ...
  vim.tbl_extend("force", cmd_opts, { desc = "Mark all tasks done" })
)
...
vim.keymap.set(
  ...
  vim.tbl_extend("force", cmd_opts, { desc = "Mark all tasks undone" })
)

-- ---------------------------------------------------------------------------
-- Toggle headings (h1-h6)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Heading highlight colors (thanks to Linkarzu)
-- ---------------------------------------------------------------------------
